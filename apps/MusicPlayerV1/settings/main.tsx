...
const HINTS: Record<string, string> = {
  ...
  tapeArt: 'Prints the album art on the right of the written cassette label. The printed design carries no cover, so this does nothing there. Cassette style only.',
