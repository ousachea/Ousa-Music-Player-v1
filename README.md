...
Landscape sets the cover at full height on the left, with the track, the bar and its times, the
transport and the volume slider stacked to the right. There is no panel behind any of it: the
